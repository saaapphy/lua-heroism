Item = {
  -- NOTE: items are not really sorted at all
  -- these are also for testing purposes and should be removed later
  { itemID = 1, itemName = 'Debug Item', itemType = 'material', itemValue = 6000},
  { itemID = 2, itemName = 'Test Weapon', itemType = 'weapon', itemWeaponType = 'melee', itemDamage = 5, itemValue = 6000},
